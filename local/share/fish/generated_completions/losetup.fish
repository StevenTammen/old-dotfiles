...
complete -c losetup -s j -l associated --description 'Show the status of all loop devices associated with the given R file .'
...
complete -c losetup -s o -l offset --description 'The data start is moved offset bytes into the specified file or device.'
...
complete -c losetup -l show --description 'Display the name of the assigned loop device if the  -f option and a  file ar…'
