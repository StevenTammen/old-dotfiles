...
complete -c find -o ls --description 'The + and - prefixes signify greater than and less than, as usual.'
complete -c find -o 1M --description 'is not equivalent to.'
complete -c find -o 1048576c --description 'The former only matches empty files, the latter matches files from 1 to 1,048…'
