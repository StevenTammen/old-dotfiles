...
complete -c mount -s o --description 'option along with.'
complete -c mount -l bind --description 'for example: mount --bind,ro foo foo This feature is not supported by Linux k…'
...
complete -c mount -o oc --description ').'
