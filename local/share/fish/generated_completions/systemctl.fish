...
complete -c systemctl -s a -l all --description 'When listing units, show all loaded units, regardless of their state, includi…'
...
complete -c systemctl -l message --description 'When used with halt, poweroff, reboot or kexec, set a short message explainin…'
complete -c systemctl -l now --description 'When used with enable, the units will also be started.'
complete -c systemctl -l root --description 'When used with enable/disable/is-enabled (and related commands), use an alter…'
...
complete -c systemctl -l plain --description 'When used with list-dependencies, list-units or list-machines, the the output…'
