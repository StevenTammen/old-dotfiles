...
complete -c git-format-patch -o 'O<orderfile>' --description 'Output the patch in the order specified in the <orderfile>, which has one she…'
...
complete -c git-format-patch -l signoff --description 'Add Signed-off-by: line to the commit message, using the committer identity o…'
