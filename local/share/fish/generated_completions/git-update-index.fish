...
complete -c git-update-index -l untracked-cache -l no-untracked-cache --description 'Enable or disable untracked cache extension.'
complete -c git-update-index -l force-untracked-cache --description 'For safety, --untracked-cache performs tests on the working directory to make…'
