...
complete -c git-pull -l verify-signatures -l no-verify-signatures --description 'Verify that the commits being merged have good and trusted GPG signatures and…'
...
complete -c git-pull -s M --description 'subtree[=<path>].'
