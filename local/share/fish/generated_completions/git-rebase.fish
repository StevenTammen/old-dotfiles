...
complete -c git-rebase -l autostash -l no-autostash --description 'Automatically create a temporary stash before the operation begins, and apply…'
...
complete -c git-rebase -s M --description 'subtree[=<path>].'
