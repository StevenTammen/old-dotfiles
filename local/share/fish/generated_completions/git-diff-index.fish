...
complete -c git-diff-index -l ws-error-highlight --description 'Highlight whitespace errors on lines specified by <kind> in the color specifi…'
...
complete -c git-diff-index -o 'O<orderfile>' --description 'Output the patch in the order specified in the <orderfile>, which has one she…'
